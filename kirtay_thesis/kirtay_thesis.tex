...
Emotion}
%\title{Computational Approaches on Modeling Brain Mechanisms} %% If you want to specify a linebreak
...
\secondmember{Professor Tankut Bar\i\c{s} Aktemur}


% Include the other members of your committee. 
\thirdmember{Professor Sanem Sar{\i}el }[Department of Computer Engineering]
